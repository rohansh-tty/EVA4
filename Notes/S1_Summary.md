...
Layers also seem to transform the data( depending on the Kernels used) in certain way. In general, the way these layers transform input data is by parameters(weights, kernel values etc). 
