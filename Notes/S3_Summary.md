...
In this case we implement 1x1 Kernel instead of 3x3 Kernel. But the reason behind using this is important. There are 3 different reasons why it's replaced.
